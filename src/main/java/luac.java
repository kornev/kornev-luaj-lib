...
public class luac {
  ...
  private static final String usage =
      "usage: java -cp luaj-jse.jar luac [options] [filenames].\n"
          ...
          + "  -i<n>    number format 'n', (n=0,1 or 4, default="
          + DumpState.NUMBER_FORMAT_DEFAULT
          + ")\n"
  ...
  private void processScript(
      Globals globals, InputStream script, String chunkname, OutputStream out) throws IOException {
    try {
      // create the chunk
