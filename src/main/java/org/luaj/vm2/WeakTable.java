 ...
 *
 * <p>Normally these are not created directly, but indirectly when changing the mode of a {@link
 * LuaTable} as lua script executes.
 *
 * <p>However, calling the constructors directly when weak tables are required from Java will reduce
 * overhead.
 */
public class WeakTable implements Metatable {
  ...
  public abstract static class WeakSlot implements Slot {
