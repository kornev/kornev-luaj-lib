 ...
 * @see <a href="http://www.lua.org/manual/5.2/manual.html#6.7">Lua 5.2 Bitwise Operation Lib
 *     Reference</a>
 */
  ...
  static final class Bit32LibV extends VarArgFunction {
    public Varargs invoke(Varargs args) {
      switch (opcode) {
        ...
        case 6:
          return Bit32Lib.replace(
              args.checkint(1), args.checkint(2), args.checkint(3), args.optint(4, 1));
      }
      return NIL;
    }
  }
