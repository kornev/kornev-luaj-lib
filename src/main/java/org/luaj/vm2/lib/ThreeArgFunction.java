 ...
 * value.
 *
 * <p>Subclasses need only implement {@link LuaValue#call(LuaValue,LuaValue,LuaValue)} to complete
 * this class, simplifying development. All other uses of {@link #call()}, {@link
 * #invoke(Varargs)},etc, are routed through this method by this class, dropping or extending
 * arguments with {@code nil} values as required.
 *
 * <p>If more or less than three arguments are required, or variable argument or variable return
 * values, then use one of the related function {@link ZeroArgFunction}, {@link OneArgFunction},
 * {@link TwoArgFunction}, or {@link VarArgFunction}.
 *
