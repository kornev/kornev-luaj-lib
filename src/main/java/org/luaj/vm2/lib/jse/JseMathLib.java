 ...
 *
 * <p>It contains all lua math functions, including those not available on the JME platform. See
 * {@link org.luaj.vm2.lib.MathLib} for the exception list.
 *
...
public class JseMathLib extends org.luaj.vm2.lib.MathLib {
   ...
   *
   * <p>Specifically, adds all library functions that can be implemented directly in JSE but not
   * JME: acos, asin, atan, atan2, cosh, exp, log, pow, sinh, and tanh.
   *
