...
/**
 * Subclass of {@link IoLib} and therefore {@link LibFunction} which implements the lua standard
 * {@code io} library for the JSE platform.
 *
 * <p>It uses RandomAccessFile to implement seek on files.
 *
