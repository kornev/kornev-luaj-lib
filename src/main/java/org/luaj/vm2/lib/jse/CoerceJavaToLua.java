 ...
 *
 * <p>This class is primarily used by the {@link org.luaj.vm2.lib.jse.LuajavaLib}, but can also be
 * used directly when working with Java/lua bindings.
 *
 * <p>To coerce scalar types, the various, generally the {@code valueOf(type)} methods on {@link
 * LuaValue} may be used:
 *
 * <ul>
 *   <li>{@link LuaValue#valueOf(boolean)}
 *   <li>{@link LuaValue#valueOf(byte[])}
 *   <li>{@link LuaValue#valueOf(double)}
 *   <li>{@link LuaValue#valueOf(int)}
 *   <li>{@link LuaValue#valueOf(String)}
 * </ul>
 *
 * <p>To coerce arrays of objects and lists, the {@code listOf(..)} and {@code tableOf(...)} methods
 * on {@link LuaValue} may be used:
 *
 * <ul>
 *   <li>{@link LuaValue#listOf(LuaValue[])}
 *   <li>{@link LuaValue#listOf(LuaValue[], org.luaj.vm2.Varargs)}
 *   <li>{@link LuaValue#tableOf(LuaValue[])}
 *   <li>{@link LuaValue#tableOf(LuaValue[], LuaValue[], org.luaj.vm2.Varargs)}
 * </ul>
 *
 * The method {@link CoerceJavaToLua#coerce(Object)} looks as the type and dimesioning of the
 * argument and tries to guess the best fit for corrsponding lua scalar, table, or table of tables.
 *
...
public class CoerceJavaToLua {
   ...
   *
   * <p>Integral types {@code boolean}, {@code byte}, {@code char}, and {@code int} will become
   * {@link LuaInteger}; {@code long}, {@code float}, and {@code double} will become {@link
   * LuaDouble}; {@code String} and {@code byte[]} will become {@link LuaString}; types inheriting
   * from {@link LuaValue} will be returned without coercion; other types will become {@link
   * LuaUserdata}.
   *
