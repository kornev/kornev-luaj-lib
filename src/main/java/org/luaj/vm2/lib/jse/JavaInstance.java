 ...
 *
 * <p>Will respond to get() and set() by returning field values or methods.
 *
 * <p>This class is not used directly. It is returned by calls to {@link
 * CoerceJavaToLua#coerce(Object)} when a subclass of Object is supplied.
 *
 * @see CoerceJavaToLua
 * @see CoerceLuaToJava
 */
class JavaInstance extends LuaUserdata {
  ...
  public LuaValue get(LuaValue key) {
    if (jclass == null) jclass = JavaClass.forClass(m_instance.getClass());
    ...
    if (c != null) return JavaClass.forClass(c);
