 ...
 *
 * <p>To coerce to specific Java values, generally the {@code toType()} methods on {@link LuaValue}
 * may be used:
 *
 * <ul>
 *   <li>{@link LuaValue#toboolean()}
 *   <li>{@link LuaValue#tobyte()}
 *   <li>{@link LuaValue#tochar()}
 *   <li>{@link LuaValue#toshort()}
 *   <li>{@link LuaValue#toint()}
 *   <li>{@link LuaValue#tofloat()}
 *   <li>{@link LuaValue#todouble()}
 *   <li>{@link LuaValue#tojstring()}
 *   <li>{@link LuaValue#touserdata()}
 *   <li>{@link LuaValue#touserdata(Class)}
 * </ul>
 *
 * <p>For data in lua tables, the various methods on {@link LuaTable} can be used directly to
 * convert data to something more useful.
 *
...
public class CoerceLuaToJava {
   ...
   * @return number of inheritance levels between subclass and baseclass, or SCORE_UNCOERCIBLE if
   *     not a subclass
   */
  static final int inheritanceLevels(Class baseclass, Class subclass) {
    ...
    int min =
        Math.min(SCORE_UNCOERCIBLE, inheritanceLevels(baseclass, subclass.getSuperclass()) + 1);
