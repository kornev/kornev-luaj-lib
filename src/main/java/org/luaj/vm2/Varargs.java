...
/**
 * Class to encapsulate varargs values, either as part of a variable argument list, or multiple
 * return values.
 *
 * <p>To construct varargs, use one of the static methods such as {@code
 * LuaValue.varargsOf(LuaValue,LuaValue)}
 *
 * <p>
 *
 * <p>Any LuaValue can be used as a stand-in for Varargs, for both calls and return values. When
 * doing so, nargs() will return 1 and arg1() or arg(1) will return this. This simplifies the case
 * when calling or implementing varargs functions with only 1 argument or 1 return value.
 *
 * <p>Varargs can also be derived from other varargs by appending to the front with a call such as
 * {@code LuaValue.varargsOf(LuaValue,Varargs)} or by taking a portion of the args using {@code
...
public abstract class Varargs {
  ...
  /**
   * Tests if argument i is a number. Since anywhere a number is required, a string can be used that
   * is a number, this will return true for both numbers and strings that can be interpreted as
   * numbers.
   *
   * @param i the index of the argument to test, 1 is the first argument
   * @return true if the argument exists and is a number or string that can be interpreted as a
  ...
  /**
   * Tests if argument i is a string. Since all lua numbers can be used where strings are used, this
   * will return true for both strings and numbers.
   *
   * @param i the index of the argument to test, 1 is the first argument
  ...
  /**
   * Return argument i as a boolean value, {@code defval} if nil, or throw a LuaError if any other
   * type.
   *
   * @param i the index of the argument to test, 1 is the first argument
   * @return true if argument i is boolean true, false if it is false, or defval if not supplied or
   *     nil
  ...
  /**
   * Return argument i as a double, {@code defval} if nil, or throw a LuaError if it cannot be
   * converted to one.
   *
   * @param i the index of the argument to test, 1 is the first argument
   * @return java double value if argument i is a number or string that converts to a number, or
  ...
  /**
   * Return argument i as a function, {@code defval} if nil, or throw a LuaError if an incompatible
   * type.
   *
   * @param i the index of the argument to test, 1 is the first argument
   * @return LuaValue that can be called if argument i is lua function or closure, or defval if not
   *     supplied or nil
  ...
  /**
   * Return argument i as a java int value, discarding any fractional part, {@code defval} if nil,
   * or throw a LuaError if not a number.
   *
   * @param i the index of the argument to test, 1 is the first argument
   * @return int value with fraction discarded and truncated if necessary if argument i is number,
   *     or defval if not supplied or nil
   * @exception LuaError if the argument is not a number
   */
  ...
  /**
   * Return argument i as a java int value, {@code defval} if nil, or throw a LuaError if not a
   * number or is not representable by a java int.
   *
   * @param i the index of the argument to test, 1 is the first argument
   * @return LuaInteger value that fits in a java int without rounding, or defval if not supplied or
   *     nil
  ...
  /**
   * Return argument i as a java long value, discarding any fractional part, {@code defval} if nil,
   * or throw a LuaError if not a number.
   *
   * @param i the index of the argument to test, 1 is the first argument
  ...
  /**
   * Return argument i as a LuaNumber, {@code defval} if nil, or throw a LuaError if not a number or
   * string that can be converted to a number.
   *
   * @param i the index of the argument to test, 1 is the first argument, or defval if not supplied
   *     or nil
  ...
  /**
   * Return argument i as a java String if a string or number, {@code defval} if nil, or throw a
  ...
  /**
   * Return argument i as a LuaString if a string or number, {@code defval} if nil, or throw a
   * LuaError if any other type
   *
   * @param i the index of the argument to test, 1 is the first argument
  ...
  /**
   * Return argument i as a LuaTable if a lua table, {@code defval} if nil, or throw a LuaError if
   * any other type.
   *
   * @param i the index of the argument to test, 1 is the first argument
  ...
  /**
   * Return argument i as a LuaThread if a lua thread, {@code defval} if nil, or throw a LuaError if
   * any other type.
   *
   * @param i the index of the argument to test, 1 is the first argument
  ...
  /**
   * Return argument i as a java Object if a userdata, {@code defval} if nil, or throw a LuaError if
   * any other type.
   *
   * @param i the index of the argument to test, 1 is the first argument
   ...
   * @return java Object value if argument i is a userdata whose instance Class c or a subclass, or
   *     defval if not supplied or nil
   * @exception LuaError if the argument is not a userdata or from whose instance c is not
   *     assignable
   */
  ...
  /**
   * Return argument i as a java int value, or throw an error if not a number or is not
   * representable by a java int.
   *
   * @param i the index of the argument to test, 1 is the first argument
  ...
  /**
   * Return argument i as a LuaNumber, or throw an error if not a number or string that can be
  ...
  /**
   * Return argument i as a java Object if it is a userdata whose instance Class c or a subclass, or
   * throw an error if any other type.
   *
   * @param i the index of the argument to test, 1 is the first argument
   * @param c the class to which the userdata instance must be assignable
  ...
  /**
   * Performs test on argument i as a LuaValue when a user-supplied assertion passes, or throw an
   * error. Returns normally if the value of {@code test} is {@code true}, otherwise throws and
   * argument error with the supplied message, {@code msg}.
   *
  ...
  /**
   * Return argument i as a java byte value, discarding any fractional part and truncating, or 0 if
   * not a number.
   *
   * @param i the index of the argument to convert, 1 is the first argument
  ...
  /**
   * Return argument i as a java char value, discarding any fractional part and truncating, or 0 if
   * not a number.
   *
   * @param i the index of the argument to convert, 1 is the first argument
  ...
  /**
   * Return argument i as a java float value, discarding excess fractional part and truncating, or 0
   * if not a number.
   *
   * @param i the index of the argument to convert, 1 is the first argument
   * @return float value with excess fraction discarded and truncated if necessary if argument i is
   *     number, otherwise 0
   */
  ...
  /**
   * Return argument i as a java int value, discarding any fractional part and truncating, or 0 if
   * not a number.
   *
   * @param i the index of the argument to convert, 1 is the first argument
   * @return int value with fraction discarded and truncated if necessary if argument i is number,
  ...
  /**
   * Return argument i as a java long value, discarding any fractional part and truncating, or 0 if
   * not a number.
   *
   * @param i the index of the argument to convert, 1 is the first argument
   * @return long value with fraction discarded and truncated if necessary if argument i is number,
  ...
  /**
   * Return argument i as a java short value, discarding any fractional part and truncating, or 0 if
   * not a number.
   *
   * @param i the index of the argument to convert, 1 is the first argument
   ...
   */
  public abstract Varargs subargs(final int start);
  ...
  static class SubVarargs extends Varargs {
    ...
    public Varargs subargs(final int start) {
      ...
      if (start > 0) {
        if (newstart >= this.end) return LuaValue.NONE;
        if (newstart == this.end) return v.arg(this.end);
   ...
   *
   * <p>This is an internal class not intended to be used directly. Instead use the corresponding
   * static method on LuaValue.
   *
   * @see LuaValue#varargsOf(LuaValue, Varargs)
   */
  static final class PairVarargs extends Varargs {
    ...
    public Varargs subargs(final int start) {
      if (start == 1) return this;
      if (start == 2) return v2;
      if (start > 2) return v2.subargs(start - 1);
  ...
  static final class ArrayVarargs extends Varargs {
    ...
    public Varargs subargs(int start) {
      if (start <= 0) LuaValue.argerror(1, "start must be > 0");
      if (start == 1) return this;
      if (start > v.length) return r.subargs(start - v.length);
  ...
  static final class ArrayPartVarargs extends Varargs {
    ...
    public Varargs subargs(int start) {
      if (start <= 0) LuaValue.argerror(1, "start must be > 0");
      if (start == 1) return this;
      if (start > length) return more.subargs(start - length);
  ...
  /**
   * Copy values in a varargs into a destination array. Internal utility method not intended to be
   * called directly from user code.
   *
   * @return Varargs containing same values, but flattened.
   */
  void copyto(LuaValue[] dest, int offset, int length) {
    for (int i = 0; i < length; ++i) dest[offset + i] = arg(i + 1);
  }

  /**
   * Return Varargs that cannot be using a shared array for the storage, and is flattened. Internal
   * utility method not intended to be called directly from user code.
   *
