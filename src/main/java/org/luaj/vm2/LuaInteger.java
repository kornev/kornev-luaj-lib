 ...
 * ensures that policies regarding pooling of instances are encapsulated.
 *
 * <p>There are no API's specific to LuaInteger that are useful beyond what is already exposed in
 * {@link LuaValue}.
 *
 * @see LuaValue
 * @see LuaNumber
...
public class LuaInteger extends LuaNumber {
  ...
  static {
    for (int i = 0; i < 512; i++) intValues[i] = new LuaInteger(i - 256);
  }
