 ...
 *
 * <p>This is a direct translation of C lua distribution header file constants for bytecode creation
 * and processing.
 */
public class Lua {
  ...
  public static final int OP_CALL =
      29; /*	A B C	R(A), ... ,R(A+C-2) := R(A)(R(A+1), ... ,R(A+B-1)) */
  ...
  public static final int OP_TFORLOOP =
      35; /* A sBx   if R(A+1) ~= nil then { R(A)=R(A+1); pc += sBx } */
