...
public abstract class Stat extends SyntaxElement {
  ...
  public static Stat ifthenelse(
      Exp ifexp, Block ifblock, List<Exp> elseifexps, List<Block> elseifblocks, Block elseblock) {
  ...
  public static class Return extends Stat {
    ...
    public int nreturns() {
      ...
      if (n > 0 && ((Exp) values.get(n - 1)).isvarargexp()) n = -1;
      return n;
    }
  }
