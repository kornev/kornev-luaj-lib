...
public class VarInfo {
  ...
  /**
   * Return replacement variable if there is exactly one value possible, otherwise compute entire
   * collection of variables and return null. Computes the list of aall variable values, and saves
   * it for the future.
   *
