...
public class JavaBuilder {
  ...
  private static final Type[] ARG_TYPES_LUAVALUE_LUAVALUE_VARARGS = {
    TYPE_LUAVALUE, TYPE_LUAVALUE, TYPE_VARARGS
  };
  ...
  private static final Type[] ARG_TYPES_LUAVALUEARRAY_VARARGS = {
    new ArrayType(TYPE_LUAVALUE, 1), TYPE_VARARGS
  };
  private static final Type[] ARG_TYPES_LUAVALUE_LUAVALUE_LUAVALUE = {
    TYPE_LUAVALUE, TYPE_LUAVALUE, TYPE_LUAVALUE
  };
  ...
  private static final String[] SUPER_NAME_N = {
    STR_FUNC0, STR_FUNC1, STR_FUNC2, STR_FUNC3, STR_FUNCV,
  };
  private static final ObjectType[] RETURN_TYPE_N = {
    TYPE_LUAVALUE, TYPE_LUAVALUE, TYPE_LUAVALUE, TYPE_LUAVALUE, TYPE_VARARGS,
  };
  ...
  private static final String[][] ARG_NAMES_N = {
    {}, {"arg"}, {"arg1", "arg2"}, {"arg1", "arg2", "arg3"}, {"args"},
  };
  ...
  public void initializeSlots() {
    ...
    if (superclassType == SUPERTYPE_VARARGS) {
        ...
        if (pi.isInitialValueUsed(slot)) {
          ...
          append(
              factory.createInvoke(
                  STR_VARARGS, "arg", TYPE_LUAVALUE, ARG_TYPES_INT, Const.INVOKEVIRTUAL));
          storeLocal(-1, slot);
        }
      }
      append(new ALOAD(1));
      ...
      append(
          factory.createInvoke(
              STR_VARARGS, "subargs", TYPE_VARARGS, ARG_TYPES_INT, Const.INVOKEVIRTUAL));
      append(new ASTORE(1));
    } else {
  ...
  public byte[] completeClass(boolean genmain) {
    ...
    if (p.upvalues.length == 1 && superclassType == SUPERTYPE_VARARGS) {
      ...
      if (isrw) {
        append(
            factory.createInvoke(
                classname, "newupl", TYPE_LOCALUPVALUE, ARG_TYPES_LUAVALUE, Const.INVOKESTATIC));
        append(
            factory.createFieldAccess(
                classname, upvalueName(0), TYPE_LOCALUPVALUE, Const.PUTFIELD));
      } else {
    ...
    if (genmain) {
      ...
      append(
          factory.createInvoke(
              classname, Const.CONSTRUCTOR_NAME, Type.VOID, ARG_TYPES_NONE, Const.INVOKESPECIAL));
      append(new ALOAD(0));
      append(
          factory.createInvoke(
              STR_JSEPLATFORM,
  ...
  private Map<Integer, LocalVariableGen> localVarGenBySlot =
      new HashMap<Integer, LocalVariableGen>();

  private int findSlot(int slot, Map<Integer, Integer> map, String prefix, Type type) {
    Integer islot = Integer.valueOf(slot);
    if (map.containsKey(islot)) return ((Integer) map.get(islot)).intValue();
  ...
  public void storeLocal(int pc, int slot) {
    ...
    if (isupval) {
      ...
      if (isupcreate) {
        append(
            factory.createInvoke(
                classname, "newupe", TYPE_LOCALUPVALUE, ARG_TYPES_NONE, Const.INVOKESTATIC));
        append(InstructionConst.DUP);
  ...
  public void createUpvalues(int pc, int firstslot, int numslots) {
    for (int i = 0; i < numslots; i++) {
      ...
      if (isupcreate) {
        ...
        append(
            factory.createInvoke(
                classname, "newupn", TYPE_LOCALUPVALUE, ARG_TYPES_NONE, Const.INVOKESTATIC));
        append(new ASTORE(index));
      }
    }
  }
  ...
  public void loadUpvalue(int upindex) {
    ...
    if (isrw) {
      append(
          factory.createFieldAccess(
              classname, upvalueName(upindex), TYPE_LOCALUPVALUE, Const.GETFIELD));
      append(new PUSH(cp, 0));
      append(InstructionConst.AALOAD);
    } else {
      append(
          factory.createFieldAccess(
              classname, upvalueName(upindex), TYPE_LUAVALUE, Const.GETFIELD));
    }
  }
  ...
  public void storeUpvalue(int pc, int upindex, int slot) {
    ...
    if (isrw) {
      ...
      append(
          factory.createFieldAccess(
              classname, upvalueName(upindex), TYPE_LUAVALUE, Const.PUTFIELD));
    }
  }
  ...
  public void newTable(int b, int c) {
    ...
    append(
        factory.createInvoke(
            STR_LUAVALUE, "tableOf", TYPE_LUATABLE, ARG_TYPES_INT_INT, Const.INVOKESTATIC));
  }
  ...
  public void arg(int argindex) {
    if (argindex == 1) {
      append(
          factory.createInvoke(
              STR_VARARGS, "arg1", TYPE_LUAVALUE, ARG_TYPES_NONE, Const.INVOKEVIRTUAL));
    } else {
  ...
  public void getTable() {
    append(
        factory.createInvoke(
            STR_LUAVALUE, "get", TYPE_LUAVALUE, ARG_TYPES_LUAVALUE, Const.INVOKEVIRTUAL));
  }

  public void setTable() {
    append(
        factory.createInvoke(
            STR_LUAVALUE, "set", Type.VOID, ARG_TYPES_LUAVALUE_LUAVALUE, Const.INVOKEVIRTUAL));
  }
  ...
  public void unaryop(int o) {
    ...
    append(
        factory.createInvoke(STR_LUAVALUE, op, TYPE_LUAVALUE, Type.NO_ARGS, Const.INVOKEVIRTUAL));
  }
  ...
  public void binaryop(int o) {
    ...
    append(
        factory.createInvoke(
            STR_LUAVALUE, op, TYPE_LUAVALUE, ARG_TYPES_LUAVALUE, Const.INVOKEVIRTUAL));
  }
  ...
  public void compareop(int o) {
    ...
    append(
        factory.createInvoke(
            STR_LUAVALUE, op, Type.BOOLEAN, ARG_TYPES_LUAVALUE, Const.INVOKEVIRTUAL));
  }
  ...
  public void toBoolean() {
    append(
        factory.createInvoke(
            STR_LUAVALUE, "toboolean", Type.BOOLEAN, Type.NO_ARGS, Const.INVOKEVIRTUAL));
  }

  public void tostring() {
    append(
        factory.createInvoke(
            STR_BUFFER, "tostring", TYPE_LUASTRING, Type.NO_ARGS, Const.INVOKEVIRTUAL));
  }

  public void isNil() {
    append(
        factory.createInvoke(
            STR_LUAVALUE, "isnil", Type.BOOLEAN, Type.NO_ARGS, Const.INVOKEVIRTUAL));
  }
  ...
  public void call(int nargs) {
    switch (nargs) {
      case 0:
        append(
            factory.createInvoke(
                STR_LUAVALUE, "call", TYPE_LUAVALUE, ARG_TYPES_NONE, Const.INVOKEVIRTUAL));
        break;
      case 1:
        append(
            factory.createInvoke(
                STR_LUAVALUE, "call", TYPE_LUAVALUE, ARG_TYPES_LUAVALUE, Const.INVOKEVIRTUAL));
        break;
      case 2:
        append(
            factory.createInvoke(
  ...
  public void invoke(int nargs) {
    switch (nargs) {
      case -1:
        append(
            factory.createInvoke(
                STR_LUAVALUE, "invoke", TYPE_VARARGS, ARG_TYPES_VARARGS, Const.INVOKEVIRTUAL));
        break;
      case 0:
        append(
            factory.createInvoke(
                STR_LUAVALUE, "invoke", TYPE_VARARGS, ARG_TYPES_NONE, Const.INVOKEVIRTUAL));
        break;
      case 1:
        append(
            factory.createInvoke(
  ...
  private String createLuaIntegerField(int value) {
    ...
    init.append(
        factory.createInvoke(
            STR_LUAVALUE, "valueOf", TYPE_LUAINTEGER, ARG_TYPES_INT, Const.INVOKESTATIC));
  ...
  private String createLuaDoubleField(double value) {
    ...
    init.append(
        factory.createInvoke(
            STR_LUAVALUE, "valueOf", TYPE_LUANUMBER, ARG_TYPES_DOUBLE, Const.INVOKESTATIC));
    init.append(factory.createPutStatic(classname, name, TYPE_LUAVALUE));
    return name;
  }
  ...
  private String createLuaStringField(LuaString value) {
    ...
    if (ls.isValidUtf8()) {
      ...
      init.append(
          factory.createInvoke(
              STR_LUASTRING, "valueOf", TYPE_LUASTRING, ARG_TYPES_STRING, Const.INVOKESTATIC));
    } else {
      ...
      init.append(
          factory.createInvoke(
              STR_STRING, "toCharArray", TYPE_CHARARRAY, Type.NO_ARGS, Const.INVOKEVIRTUAL));
      init.append(
          factory.createInvoke(
              STR_LUASTRING, "valueOf", TYPE_LUASTRING, ARG_TYPES_CHARARRAY, Const.INVOKESTATIC));
    }
    init.append(factory.createPutStatic(classname, name, TYPE_LUAVALUE));
    return name;
  }
  ...
  public void onEndOfLuaInstruction(int pc, int line) {
    ...
    if (line != prev_line) mg.addLineNumber(beginningOfLuaInstruction, prev_line = line);
      ...
      if (branches[pc] != null) {
        ...
        if (t >= branchDestHandles.length)
          throw new IllegalArgumentException(
              "no target at or after "
                  + targets[pc]
                  + " op="
                  + Lua.GET_OPCODE(p.code[targets[pc]]));
  ...
  public void setlistStack(int pc, int a0, int index0, int nvals) {
    for (int i = 0; i < nvals; i++) {
      ...
      append(
          factory.createInvoke(
              STR_LUAVALUE, "rawset", Type.VOID, ARG_TYPES_INT_LUAVALUE, Const.INVOKEVIRTUAL));
    }
  }
  ...
  public void setlistVarargs(int index0, int vresultbase) {
    ...
    append(
        factory.createInvoke(
            STR_LUAVALUE, "rawsetlist", Type.VOID, ARG_TYPES_INT_VARARGS, Const.INVOKEVIRTUAL));
  }

  public void concatvalue() {
    append(
        factory.createInvoke(
            STR_LUAVALUE, "concat", TYPE_LUAVALUE, ARG_TYPES_LUAVALUE, Const.INVOKEVIRTUAL));
  }

  public void concatbuffer() {
    append(
        factory.createInvoke(
            STR_LUAVALUE, "concat", TYPE_BUFFER, ARG_TYPES_BUFFER, Const.INVOKEVIRTUAL));
  }

  public void tobuffer() {
    append(
        factory.createInvoke(
            STR_LUAVALUE, "buffer", TYPE_BUFFER, Type.NO_ARGS, Const.INVOKEVIRTUAL));
  }

  public void tovalue() {
    append(
        factory.createInvoke(
            STR_BUFFER, "value", TYPE_LUAVALUE, Type.NO_ARGS, Const.INVOKEVIRTUAL));
  }
