 ...
 *
 * <p>{@link LuaError} is used wherever a lua call to {@code error()} would be used within a script.
 *
 * <p>Since it is an unchecked exception inheriting from {@link RuntimeException}, Java method
 * signatures do notdeclare this exception, althoug it can be thrown on almost any luaj Java
 * operation. This is analagous to the fact that any lua script can throw a lua error at any time.
 *
 * <p>The LuaError may be constructed with a message object, in which case the message is the string
 * representation of that object. getMessageObject will get the object supplied at construct time,
 * or a LuaString containing the message of an object was not supplied.
 */
public class LuaError extends RuntimeException {
  ...
  public String getMessage() {
    ...
    if (fileline != null) return fileline + " " + m;
    return m;
  }
   ...
   *
   * <p>All errors generated from lua code should throw LuaError(String) instead.
   *
