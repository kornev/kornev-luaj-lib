...
public class TableHashTest extends TestCase {
  ...
  public void testSetRemove() {
    ...
    String[] keys = {
      "abc", "def", "ghi", "jkl", "mno", "pqr", "stu", "wxy", "z01", "cd", "ef", "g", "hi", "jk",
      "lm", "no", "pq", "rs",
    };
    ...
    for (int i = 0; i < keys.length; ++i) {
      ...
      if (i < keys.length - 1) assertEquals(capacities[keys.length], t.getHashLength());
      else assertTrue(0 <= t.getHashLength());
    }
    for (int i = 0; i < keys.length; ++i) {
