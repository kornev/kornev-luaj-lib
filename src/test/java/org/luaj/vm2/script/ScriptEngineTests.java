...
public class ScriptEngineTests extends TestSuite {
  ...
  public abstract static class EngineTestCase extends TestCase {
    ...
    public void testBindingJavaInt() throws ScriptException {
      CompiledScript cs =
          ((Compilable) e).compile("y = x; return 'x '..type(x)..' '..tostring(x)\n");
      b.put("x", 111);
    ...
    public void testBindingJavaArray() throws ScriptException {
      CompiledScript cs =
          ((Compilable) e).compile("y = x; return 'x '..type(x)..' '..#x..' '..x[1]..' '..x[2]\n");
    ...
    public void testBindingLuaFunction() throws ScriptException {
      CompiledScript cs =
          ((Compilable) e).compile("y = function(x) return 678 + x end; return 'foo'");
