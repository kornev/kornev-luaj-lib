...
public class TypeTest extends TestCase {
  ...
  private final LuaFunction somefunc =
      new ZeroArgFunction() {
  ...
  public void testOptInteger() {
    ...
    assertEquals(
        LuaValue.valueOf((int) sampledouble), doubledouble.optinteger(LuaValue.valueOf(33)));
    ...
    assertEquals(
        LuaValue.valueOf((int) sampledouble), stringdouble.optinteger(LuaValue.valueOf(33)));
