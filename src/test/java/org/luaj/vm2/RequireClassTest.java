...
public class RequireClassTest extends TestCase {
  ...
  public void testRequireClassSuccess() {
    ...
    assertEquals(
        "require-sample-success-org.luaj.vm2.require.RequireSampleSuccess", result.tojstring());
    ...
    try {
      ...
      assertEquals(
          "loop or previous error loading module '"
              + RequireSampleLoadLuaError.class.getName()
              + "'",
          le.getMessage());
    }
  }
  ...
  public void testRequireClassLoadRuntimeException() {
    ...
    try {
      ...
      assertEquals(
          "loop or previous error loading module '"
              + RequireSampleLoadRuntimeExcep.class.getName()
              + "'",
          le.getMessage());
    }
  }
