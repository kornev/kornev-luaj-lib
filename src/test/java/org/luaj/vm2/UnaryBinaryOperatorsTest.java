...
public class UnaryBinaryOperatorsTest extends TestCase {
  ...
  public void testDoublesBecomeInts() {
    ...
    LuaValue ia = LuaInteger.valueOf(345),
        da = LuaDouble.valueOf(345.0),
        db = LuaDouble.valueOf(345.5);
    LuaValue sa = LuaValue.valueOf("3.0"),
        sb = LuaValue.valueOf("3"),
        sc = LuaValue.valueOf("-2.0"),
  ...
  public void testEqualsInt() {
    LuaValue ia = LuaInteger.valueOf(345),
        ib = LuaInteger.valueOf(345),
        ic = LuaInteger.valueOf(-345);
    LuaString sa = LuaString.valueOf("345"),
        sb = LuaString.valueOf("345"),
  ...
  public void testEqualsDouble() {
    LuaValue da = LuaDouble.valueOf(345.5),
        db = LuaDouble.valueOf(345.5),
        dc = LuaDouble.valueOf(-345.5);
    LuaString sa = LuaString.valueOf("345.5"),
        sb = LuaString.valueOf("345.5"),
        sc = LuaString.valueOf("-345.5");
  ...
  private static final TwoArgFunction RETURN_NIL =
      new TwoArgFunction() {
  ...
  private static final TwoArgFunction RETURN_ONE =
      new TwoArgFunction() {
        public LuaValue call(LuaValue lhs, LuaValue rhs) {
          return ONE;
        }
  ...
  public void testArithErrors() {
    ...
    LuaValue[] numerics = {
      LuaValue.valueOf(111), LuaValue.valueOf(55.25), LuaValue.valueOf("22.125")
    };
  ...
  private static final TwoArgFunction RETURN_LHS =
      new TwoArgFunction() {
        public LuaValue call(LuaValue lhs, LuaValue rhs) {
          return lhs;
        }
  ...
  private static final TwoArgFunction RETURN_RHS =
      new TwoArgFunction() {
        public LuaValue call(LuaValue lhs, LuaValue rhs) {
          return rhs;
        }
